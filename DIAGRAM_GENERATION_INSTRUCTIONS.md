...
This document contains the Mermaid code that you can use to generate the architecture diagrams as images.

## How to Generate Diagram Images

### Method 1: Using Mermaid Live Editor
1. Go to https://mermaid.live
2. Copy and paste each Mermaid code block below
3. Click "Actions" → "Download PNG/SVG" to save the diagram as an image

### Method 2: Using VS Code with Mermaid Plugin
1. Install the Mermaid Preview plugin
2. Create a .mmd file with the code
3. Use the preview feature and export as image

### Method 3: Using Command Line Tools
1. Install mermaid-cli: `npm install -g @mermaid-js/mermaid-cli`
2. Save each diagram to a separate .mmd file
3. Generate image: `mmdc -i diagram.mmd -o diagram.png`
...
## Low-Level Architecture (LLD) Diagram
